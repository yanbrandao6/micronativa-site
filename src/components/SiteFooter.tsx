...
export function SiteFooter() {
  return <footer className="bg-[#0d2f29] text-white">
    <div className="container-site grid gap-10 py-16 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div><h2 className="font-bold">Navegação</h2><ul className="mt-4 space-y-3 text-sm text-white/70"><li><Link href="/projetos">Projetos</Link></li><li><Link href="/sobre">Sobre a empresa</Link></li><li><Link href="/contato">Contato</Link></li><li><Link href="/politica-de-privacidade">Política de Privacidade</Link></li></ul></div>
